...
#ifndef _LMAX_FIXM_SBE_LOGOUT_H_
#define _LMAX_FIXM_SBE_LOGOUT_H_
...
private:
    ...
    inline void reset(const Logout& codec)
    {
...
public:
    ...
    Logout() : m_buffer(nullptr), m_bufferLength(0), m_offset(0) {}
    ...
    Logout(char *buffer, const std::uint64_t bufferLength, const std::uint64_t actingBlockLength, const std::uint64_t actingVersion)
    {
        reset(buffer, 0, bufferLength, actingBlockLength, actingVersion);
    }

    Logout(const Logout& codec)
    {
        reset(codec);
    }
    ...
    Logout& operator=(const Logout& codec)
    {
        reset(codec);
        return *this;
    }
...
public:
    ...
    VarString &text()
    {
        m_text.wrap(m_buffer, m_offset + 0, m_actingVersion, m_bufferLength);
        return m_text;
    }
};
}
