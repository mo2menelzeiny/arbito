...
#ifndef _LMAX_FIXM_SBE_TESTREQUEST_H_
#define _LMAX_FIXM_SBE_TESTREQUEST_H_
...
private:
    ...
    inline void reset(const TestRequest& codec)
    {
...
public:
    ...
    TestRequest() : m_buffer(nullptr), m_bufferLength(0), m_offset(0) {}

    TestRequest(char *buffer, const std::uint64_t bufferLength)
    {
        reset(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }

    TestRequest(char *buffer, const std::uint64_t bufferLength, const std::uint64_t actingBlockLength, const std::uint64_t actingVersion)
    {
        reset(buffer, 0, bufferLength, actingBlockLength, actingVersion);
    }

    TestRequest(const TestRequest& codec)
    {
        reset(codec);
    }

#if __cplusplus >= 201103L
    TestRequest(TestRequest&& codec)
    {
        reset(codec);
    }

    TestRequest& operator=(TestRequest&& codec)
    {
        reset(codec);
        return *this;
    }
    ...
    TestRequest& operator=(const TestRequest& codec)
    {
        reset(codec);
        return *this;
    }
    ...
    TestRequest &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        reset(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
        return *this;
    }

    TestRequest &wrapForDecode(
...
#pragma clang diagnostic pop
    ...
    TestRequest &putTestReqID(const char *src)
    {
    ...
    TestRequest &putTestReqID(const std::string& str)
    {
