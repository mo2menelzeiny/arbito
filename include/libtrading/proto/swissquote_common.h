...
int swissquote_fix_session_order_cancel_request(struct swissquote_fix_session *session,
                                                struct swissquote_fix_field *fields, long nr_fields);

int swissquote_fix_session_order_cancel_replace(struct swissquote_fix_session *session,
                                                struct swissquote_fix_field *fields, long nr_fields);

int swissquote_fix_session_execution_report(struct swissquote_fix_session *session, struct swissquote_fix_field *fields,
                                            long nr_fields);
