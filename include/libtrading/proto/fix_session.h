#ifndef ARBITO_CFIXSESSION_H
#define ARBITO_CFIXSESSION_H
...
struct fix_session_cfg *
fix_session_cfg_new(const char *sender_comp_id, const char *target_comp_id, int heartbtint, const char *dialect,
                    int sockfd);
