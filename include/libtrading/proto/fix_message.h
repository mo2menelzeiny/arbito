...
enum fix_msg_type {
	...
	FIX_MSG_TYPE_MARKET_DATA_INCREMENTAL_REFRESH = 9, //X
	FIX_MSG_TYPE_MARKET_DATA_REQUEST_REJECT = 10, //Y
	FIX_MSG_TYPE_EXECUTION_REPORT = 11, //8
	FIX_MSG_TYPE_ORDER_CANCEL_REJECT = 12, //9
	FIX_MSG_TYPE_NEW_ORDER_SINGLE = 13, //D
	FIX_MSG_TYPE_ORDER_CANCEL_REQUEST = 14,
	FIX_MSG_TYPE_ORDER_CANCEL_REPLACE_REQUEST = 15, //G
	FIX_MSG_TYPE_ORDER_STATUS_REQUEST = 16, //H
	FIX_MSG_TYPE_TRADE_CAPTURE_REPORT_REQUEST = 17, //AD
	FIX_MSG_TYPE_TRADE_CAPTURE_REPORT = 18, //AE
	FIX_MSG_TYPE_TRADE_CAPTURE_REPORT_REQUEST_ACK = 19, //AQ
	FIX_MSG_TYPE_QUOTE_REQUEST = 20, //R
	FIX_MSG_TYPE_MASS_QUOTE = 21, //i
	FIX_MSG_TYPE_MASS_QUOTE_ACK = 22, //b
	FIX_MSG_TYPE_QUOTE_REQUEST_REJECT = 23, //AG
	FIX_MSG_TYPE_QUOTE_CANCEL = 24, //Z
	FIX_MSG_TYPE_QUOTE = 25, //S
	FIX_MSG_TYPE_QUOTE_RESPONSE = 26, // AJ
	FIX_MSG_TYPE_NEW_ORDER_LIST = 27, //E
	FIX_MSG_TYPE_REQUEST_FOR_POSITIONS = 28, //AN
	FIX_MSG_TYPE_REQUEST_FOR_POSITIONS_ACK = 29, //AO
	FIX_MSG_TYPE_POSITION_REPORT = 30, //AP
	FIX_MSG_TYPE_ORDER_MASS_STATUS_REQUEST = 31, //AF
