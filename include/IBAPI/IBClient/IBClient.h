...
typedef std::function<void(double bidPrice, double askPrice, int bidSize, int askSize)> OnTickByTickHandler;
...
public:
	...
	void placeMarketOrder(const char *action, double quantity);
