...
#ifndef _SBE_VARDATAENCODING_H_
#define _SBE_VARDATAENCODING_H_
...
public:
    VarDataEncoding() : m_buffer(nullptr), m_offset(0) {}
    ...
    VarDataEncoding& operator=(VarDataEncoding&& codec) SBE_NOEXCEPT
    {
        m_buffer = codec.m_buffer;
        m_bufferLength = codec.m_bufferLength;
        m_offset = codec.m_offset;
    ...
    VarDataEncoding& operator=(const VarDataEncoding& codec) SBE_NOEXCEPT
    {
        m_buffer = codec.m_buffer;
        m_bufferLength = codec.m_bufferLength;
        m_offset = codec.m_offset;
